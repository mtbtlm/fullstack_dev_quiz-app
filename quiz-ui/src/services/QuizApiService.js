...
export default {
    ...
    updateQuestion(token, q_id, json) {
        console.log("Update Question with token : \n" + token + "\n\nJSON :\n" + JSON.stringify(json))
        return this.call("put", "questions/" + q_id, json, token);
    },
    ...
    idByPosition(position) {
        return this.call("get", "questions/idpos?position=" + position)
    },
};